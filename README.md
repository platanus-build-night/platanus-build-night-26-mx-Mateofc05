# Mateo Flores Caballero Mier — Platanus Build Night — Ciudad de México Project
...
- Mateo Flores Caballero Mier ([@Mateofc05](https://github.com/Mateofc05))
...
2. Point your local `origin` at **both** repos, so a single `git push` updates each one:
   ...
   git remote set-url --add --push origin https://github.com/platanus-build-night/platanus-build-night-26-mx-Mateofc05.git
